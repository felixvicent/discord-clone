  ...
  return (
    <>
      ...
      >
        ...
        <p
          className="font-semibold text-sm tezt-zinc-500 dark:text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition"
        >
          Busca
        </p>
        <kbd
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <CommandInput placeholder="Busque canais e membros" />
        <CommandList>
